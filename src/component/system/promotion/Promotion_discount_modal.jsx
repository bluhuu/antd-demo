              ...
              <Col span="11" >
                ...
                <FormItem {...formItemLayout} label={rowData.PromotionRuleType=="AMT"?"购满金额:":"购满件数:"} style={{margin:"3px 0px"}}>
                  {rowData.PromotionRuleType=="AMT"
                    ? <Input {...getFieldProps('SBuyAmt', {initialValue:rowData.SBuyAmt})} type="text" autoComplete="off" size="small" addonAfter="元"/>
                    : <Input {...getFieldProps('SProductQty', {initialValue:rowData.SProductQty})} type="text" autoComplete="off" size="small" addonAfter="件"/>}
                </FormItem>
              ...
              <Col span="11">
                ...
                <FormItem {...formItemLayout} label={rowData.PromotionReduceType=="AMT"?"减免金额:":"减免折扣:"} style={{margin:"3px 0px"}}>
                  {rowData.PromotionReduceType=="AMT"
                    ? <Input {...getFieldProps('reductionAmt', {initialValue:rowData.ReductionAmt})} type="text" autoComplete="off" size="small" addonAfter="元"/>
                    : <div style={{width:"80"}}><Input {...getFieldProps('Discount', {initialValue:rowData.Discount})} type="text" autoComplete="off" size="small" addonAfter="%"/> </div>}
                </FormItem>
