...
let Promotion_discount_modal_add = React.createClass({
  getInitialState() {
  ...
  render() {
    ...
    return (
      <div style={{display:'inline'}}>
        <Button type="primary" onClick={this.showModal} size="small"><Icon type="plus" />添 加</Button>
        <Modal title="添 加" width="680" visible={this.state.visible} onOk={this.handleSubmit} onCancel={this.hideModal}
              footer={[
...
Promotion_discount_modal_add = createForm()(Promotion_discount_modal_add);

export default Promotion_discount_modal_add;
